...
public class Main
{
	...
	public static void main(String[] args)
	{
		...
		LinearSearchImplementation linearSearchImplementation = new LinearSearchImplementation();
		...
		do
		{
			...
			case 3: 
			{
				System.out.println("Total no of companies whose stock price rose today : "
						+ linearSearchImplementation.countCompaniesInProfit(profitArray));
			...
			case 4: 
			{
				System.out.println("Total no of companies whose stock price declined today : "
						+ (noOfCompanies - linearSearchImplementation.countCompaniesInProfit(profitArray)));
